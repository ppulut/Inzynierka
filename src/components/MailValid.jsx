...
export const reservationMail = yup.object().shape({
    email2: yup.string().email("Wprowadź poprawny e-mail").required("E-mail jest wymagany")
    .test('email', 'Email został dodany na czarną listę rezerwacja nie zostanie zatwierdzona',
                function (value) {
